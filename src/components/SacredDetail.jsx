    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="space-y-4 text-center">
                ...
                <h2 className="text-4xl font-black text-white tracking-tight leading-tight px-4">
                    {post.title}
                </h2>
            ...
            <div className="grid grid-cols-2 gap-3 pb-4">
                <div className="crystal-glass rounded-3xl p-6 space-y-2">
                    <Users className="w-5 h-5 text-neon-teal mb-4" />
                ...
                <div className="crystal-glass rounded-3xl p-6 space-y-2">
                    <TrendingUp className="w-5 h-5 text-neon-pink mb-4" />
                    <p className="text-[11px] font-bold text-white/40 uppercase tracking-widest">적중 난이도</p>
                    <p className="text-2xl font-black text-white">Legendary</p>
                </div>
            </div>

            {/* Timeline Section */}
            <div className="crystal-glass rounded-[2.5rem] p-8 space-y-8 relative overflow-hidden">
                ...
                <div className="relative space-y-12">
                    ...
                    <div className="relative flex gap-6">
                        <div className="h-12 w-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 z-10">
                            <Calendar className="w-5 h-5 text-white/40" />
                        </div>
                        <div>
                            <p className="text-xs font-black text-neon-teal uppercase tracking-widest">2026.03.01</p>
                            <h4 className="text-lg font-black text-white mt-1">목표가 박제 완료</h4>
                    ...
                    <div className="relative flex gap-6">
                        <div className="h-12 w-12 rounded-full bg-neon-pink/20 border border-neon-pink/30 flex items-center justify-center shrink-0 z-10 shadow-glowPink">
                            <TrendingUp className="w-5 h-5 text-neon-pink" />
                        </div>
                        <div>
                            <p className="text-xs font-black text-neon-pink uppercase tracking-widest">{post.hitDate}</p>
                            <h4 className="text-xl font-black text-white mt-1">목표가 도달 (성지 등극)</h4>
                            <p className="text-sm text-white/50 mt-1 leading-relaxed">
                                실제 가격이 목표가에 도달하여<br />
            ...
            {/* Action CTA */}
            <button className="w-full rounded-2xl bg-white text-black py-5 text-lg font-black flex items-center justify-center gap-2 shadow-lg hover:opacity-90 transition active:scale-95">
                나도 성지순례 댓글 남기기
            </button>
