                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="relative group">
                                <input
                                    ...
                                    className={`w-full bg-white/5 border ${error ? 'border-red-500/50' : 'border-white/10'} 
                                               ...
                                               text-[18px] font-bold text-white placeholder:text-white/20
                                               transition-all duration-300 outline-none
                                               shadow-inner`}
                                    maxLength={12}
                                    autoFocus
                                />
                                <div className="absolute right-6 top-1/2 -translate-y-1/2 text-white/20 text-xs font-bold">
                                    {nickname.length}/12
                                </div>
                                {error && (
                            ...
                            <button
                                ...
                                className="w-full bg-neon-teal hover:bg-neon-teal/90 active:bg-neon-teal/80
                                           ...
                                           text-black font-black text-[17px]
                                           rounded-2xl py-5
